/*
A class named “Employee” holds information like employee code, name,gender, year of joining.
Write a program to create five hundred objects (Array of employee objects )of employee and
enter some data into it through setters. Make getters and setters for all employee information.
 Then ask the user to enter current year. Display the names of those employees whose tenure is  5
  or more than 5 years according to the given current year only using getters.
...
class Employee{
 ...
 public:
     ...
     Employee(){
     employe_code=next_employee_code++;
     }
   //  void set_employe_code();
    int get_employe_code();
...
int Employee::next_employee_code=0;
...
int main() {
    ...
    cout << "Employee Code: " << Employee::get_employe_code() << endl;
...
int current_year;
cin>>current_year;
if(current_year-year_of_joining==5 || current_year-year_of_joining>5){
return "names of employees whose tenure is 5 or more than 5 years:   " + employ_name;
}else{
return "Tenure is less then 5";
}
}
